...
class AppData {
	constructor(budget, income, incomeMonth, addIncome, expenses, addExpenses, deposit, percentDeposit, budgetDay, budgetMonth, expensesMonth) {
		this.budget = budget;
		this.income = income;
...
let appData = new AppData(0, {}, 0, [], {}, [], false, 0, 0, 0, 0, 0);
